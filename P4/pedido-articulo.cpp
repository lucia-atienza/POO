...
#include <iomanip>
//=========================LINEA PEDIDO====================================
LineaPedido::LineaPedido(double precio, unsigned cantidad /*unsigned cantidad = 1*/) : 
   precio_{precio}, 
   cantidad_{cantidad} 
{}
...
void Pedido_Articulo::pedir(Pedido& ped, Articulo& art, double precio, unsigned cantidad /*unsigned cantidad = 1*/)
{
...
void Pedido_Articulo::pedir(Articulo& art, Pedido& ped, double precio, unsigned cantidad /*unsigned cantidad = 1*/)
{
...
std::ostream& operator<<(std::ostream& os, const Pedido_Articulo::ItemsPedido& art)
{
   ...
   {
      os << std::endl << pos->second.precio_venta() << " €" << std::setw(5) << std::setfill(' ') 
         << pos->second.cantidad() << std::setw(5) << std::setfill(' ')
